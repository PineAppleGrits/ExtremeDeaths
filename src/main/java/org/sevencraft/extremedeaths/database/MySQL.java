...
public class MySQL implements DBType {
    ...
    public final String insertPlayerLifes = "INSERT INTO player(uuid,username,extra_lifes) VALUES(?,?,?) ON DUPLICATE KEY UPDATE username = VALUES(username), extra_lifes = extra_lifes + VALUES(extra_lifes);";
    public final String insertPlayerLifesUsername = "UPDATE player SET extra_lifes = extra_lifes + ? WHERE username = ? ;";
    public final String setPlayerLifes = "INSERT INTO player(uuid,username,extra_lifes ) VALUES(?,?,?) ON DUPLICATE KEY (uuid) DO UPDATE username = VALUES(username), extra_lifes = ?;";
